/**
 * Created by cyliao on 2016/5/28.
 */
...
$(function () {
    ...
    (function () {
        ...
        var iH = 0;
        var arrData = [
            {'name':'萱萱','time':4,'title':'那些灿烂华美的瞬间','url':'http://www.mi.com'},
            {'name':'畅畅','time':5,'title':'广东3天抓获涉黄嫌犯','url':'http://www.mi.com'},
            {'name':'萱萱','time':6,'title':'国台办回应王郁琦','url':'http://www.mi.com'},
            {'name':'畅畅','time':7,'title':'那些灿烂华美的瞬间','url':'http://www.mi.com'},
            {'name':'萱萱','time':8,'title':'那些灿烂华美的瞬间','url':'http://www.mi.com'},
            {'name':'畅畅','time':9,'title':'广东3天抓获涉黄嫌犯','url':'http://www.mi.com'},
            {'name':'萱萱','time':10,'title':'国台办回应王郁琦','url':'http://www.mi.com'},
            {'name':'畅畅','time':11,'title':'那些灿烂华美的瞬间','url':'http://www.mi.com'}
        ];
        var str = '';
